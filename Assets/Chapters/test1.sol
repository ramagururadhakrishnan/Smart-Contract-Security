...
pragma solidity >=0.8.7;   // SOLIDITY_PRAGMAS_VERSION
 contract examination {
    mapping(uint128=>student) private studentmap;  // SOLIDITY_VISIBILITY
    ...
    student private stud;   //SOLIDITY_VISIBILITY  //SOLIDITY_PRIVATE_MODIFIER_DONT_HIDE_DATA

    address private owner;      //SOLIDITY_VISIBILITY    // SOLIDITY_PRIVATE_MODIFIER_DONT_HIDE_DATA
    constructor() {          // SOLIDITY_VISIBILITY      // SOLIDITY_VISIBILITY
        owner = msg.sender;
    }
